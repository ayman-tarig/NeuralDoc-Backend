...
class Parser:
    ...
    def parse_document_file(cls, document_file):
        ...
        for parser_class in parser_classes:
            try:
                parser = parser_class()
                parsed_content = parser.process_document_file(document_file)
                # print("DOCUMENT PARSING IS COMPLETED SUCCESSFULLY")
    ...
    def process_document_file(self, document_file):
        ...
        for document_file_page in document_file.pages.all():
            document_file_content += self.process_document_file_page(
                document_file_page=document_file_page
            )
        # print("DOCUMENT FILE HAD BEEN PARSED")
    ...
    def process_document_file_page(self, document_file_page):
        ...
        # print(f"PAGE {document_file_page.page_number} HAD BEEN PARSED")
        return parsed_content
